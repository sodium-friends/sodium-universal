...
| `crypto_auth_PRIMITIVE`                                  | :white_check_mark: | :small_red_triangle: |
...
| `crypto_box_keypair`                                     | :white_check_mark: | :small_red_triangle: |
| `crypto_box_MACBYTES`                                    | :white_check_mark: | :small_red_triangle: |
| `crypto_box_NONCEBYTES`                                  | :white_check_mark: | :small_red_triangle: |
| `crypto_box_open_detached`                               | :white_check_mark: | :small_red_triangle: |
| `crypto_box_open_easy`                                   | :white_check_mark: | :small_red_triangle: |
| `crypto_box_PRIMITIVE`                                   | :white_check_mark: | :small_red_triangle: |
| `crypto_box_PUBLICKEYBYTES`                              | :white_check_mark: | :small_red_triangle: |
| `crypto_box_seal`                                        | :white_check_mark: | :small_red_triangle: |
| `crypto_box_seal_open`                                   | :white_check_mark: | :small_red_triangle: |
| `crypto_box_SEALBYTES`                                   | :white_check_mark: | :small_red_triangle: |
| `crypto_box_SECRETKEYBYTES`                              | :white_check_mark: | :small_red_triangle: |
| `crypto_box_seed_keypair`                                | :white_check_mark: | :small_red_triangle: |
| `crypto_box_SEEDBYTES`                                   | :white_check_mark: | :small_red_triangle: |
...
| `crypto_generichash_PRIMITIVE`                           | :white_check_mark: |  :white_check_mark:  |
| `crypto_hash`                                            | :white_check_mark: | :small_red_triangle: |
| `crypto_hash_BYTES`                                      | :white_check_mark: | :small_red_triangle: |
| `crypto_hash_PRIMITIVE`                                  | :white_check_mark: | :small_red_triangle: |
| `crypto_hash_sha256`                                     | :white_check_mark: | :small_red_triangle: |
| `crypto_hash_sha256_BYTES`                               | :white_check_mark: | :small_red_triangle: |
| `crypto_hash_sha512`                                     | :white_check_mark: | :small_red_triangle: |
| `crypto_hash_sha512_BYTES`                               | :white_check_mark: | :small_red_triangle: |
...
| `crypto_kdf_PRIMITIVE`                                   | :white_check_mark: |  :white_check_mark:  |
| `crypto_kx_client_session_keys`                          | :white_check_mark: | :small_red_triangle: |
| `crypto_kx_keypair`                                      | :white_check_mark: | :small_red_triangle: |
| `crypto_kx_PRIMITIVE`                                    | :white_check_mark: | :small_red_triangle: |
| `crypto_kx_PUBLICKEYBYTES`                               | :white_check_mark: | :small_red_triangle: |
| `crypto_kx_SECRETKEYBYTES`                               | :white_check_mark: | :small_red_triangle: |
| `crypto_kx_seed_keypair`                                 | :white_check_mark: | :small_red_triangle: |
| `crypto_kx_SEEDBYTES`                                    | :white_check_mark: | :small_red_triangle: |
...
| `crypto_onetimeauth`                                     | :white_check_mark: | :small_red_triangle: |
...
| `crypto_onetimeauth_PRIMITIVE`                           | :white_check_mark: | :small_red_triangle: |
| `crypto_onetimeauth_verify`                              | :white_check_mark: | :small_red_triangle: |
| `crypto_pwhash`                                          | :white_check_mark: | :small_red_triangle: |
| `crypto_pwhash_ALG_ARGON2I13`                            | :white_check_mark: | :small_red_triangle: |
| `crypto_pwhash_ALG_ARGON2ID13`                           | :white_check_mark: | :small_red_triangle: |
| `crypto_pwhash_ALG_DEFAULT`                              | :white_check_mark: | :small_red_triangle: |
| `crypto_pwhash_BYTES_MAX`                                | :white_check_mark: | :small_red_triangle: |
| `crypto_pwhash_BYTES_MIN`                                | :white_check_mark: | :small_red_triangle: |
| `crypto_pwhash_PRIMITIVE`                                | :white_check_mark: | :small_red_triangle: |
...
| `crypto_pwhash_STRPREFIX`                                | :white_check_mark: | :small_red_triangle: |
...
| `crypto_scalarmult_PRIMITIVE`                            | :white_check_mark: | :small_red_triangle: |
...
| `crypto_secretbox_PRIMITIVE`                             | :white_check_mark: | :small_red_triangle: |
...
| `crypto_shorthash_PRIMITIVE`                             | :white_check_mark: |  :white_check_mark:  |
...
| `crypto_stream_chacha20_KEYBYTES`                        | :white_check_mark: | :small_red_triangle: |
| `crypto_stream_chacha20_NONCEBYTES`                      | :white_check_mark: | :small_red_triangle: |
| `crypto_stream_chacha20_xor`                             | :white_check_mark: | :small_red_triangle: |
| `crypto_stream_KEYBYTES`                                 | :white_check_mark: |  :white_check_mark:  |
| `crypto_stream_NONCEBYTES`                               | :white_check_mark: |  :white_check_mark:  |
| `crypto_stream_PRIMITIVE`                                | :white_check_mark: |  :white_check_mark:  |
...
| `sodium_is_zero`                                         | :white_check_mark: | :small_red_triangle: |
| `sodium_malloc`                                          | :white_check_mark: | :small_red_triangle: |
| `sodium_memcmp`                                          | :white_check_mark: | :small_red_triangle: |
| `sodium_memzero`                                         | :white_check_mark: | :small_red_triangle: |
